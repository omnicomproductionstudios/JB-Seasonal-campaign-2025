...
function setupContent() {
  ...
  if (deploy === false) {
    ...
    if (showDefault) {
      h4[0].innerHTML = '100+<br>destinations.<br>And great fares<br>to get there.'; // - Populates main headline
      ...
      priceHolder[0].style.display = 'none'
      // Turn off Price holder etc.
      price[0].style.display = 'none';
      startingAt[0].style.display = 'none';
    } else {
      h4[0].innerHTML = "<span class='flyfrom'>Fly from</span><span class='city'>" + origin_formatted + "</span><br><span class='to'>to</span> <span class='city'>" + destination_formatted + "</span>"; // - Populates main headline
      ...
      if (myCityCharLength > 42) {
      }else if (myCityCharLength > 19) {
        myCity[0].style.fontSize = "20px"
        myCity[1].style.fontSize = "20px"
      } else if (myCityCharLength > 15) {
